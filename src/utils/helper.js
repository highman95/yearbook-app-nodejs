...
module.exports = {
    generateToken: (payload) => jwt.sign(payload, process.env.JWT_SECRET, { expiresIn: '24h', subject: 'YearBo0k-nodeJS' }),
    ...
    dbEntities: { institutions: 'institutions', divisions: 'divisions', sub_divisions: 'sub_divisions', alumni: 'alumni', alumnus_cards: 'alumnus_cards' }
}
